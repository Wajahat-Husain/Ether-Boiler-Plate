...
const TabContainer = ({ network, isStatus }) => {
    ...
    const etherObjDetails = (etherData) => {
    ...
    return (
        <>
            ...
            <TabContentContainer>
                ...
                <TabContent>
                    {activeTab === 1 ? (
                        <DashBoard network={network} userInfoDetails={userInfoDetails} etherObjDetails={etherObjDetails} />
                    ) : activeTab === 2 ? (<TransactionHistory userInfo={userInfo} etherObj={etherObj} />) :
                        activeTab === 3 ? (<CustomToken userInfo={userInfo} etherObj={etherObj} />) : (
                            <>
                            </>
                        )}
                </TabContent>
